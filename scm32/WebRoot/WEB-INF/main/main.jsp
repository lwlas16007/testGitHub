...
<body class="easyui-layout">
	...
	<div data-options="region:'west',title:'导航菜单',split:true"
		...
		<div id="aa" class="easyui-accordion"
			...
			<div title="基础数据录入">
				...
				<!--base文件夹下的goURL方法去supplier文件夹下找supplierlist.jsp  -->
					...
					<li style="padding: 6px;"><a href="${proPath}/base/goURL/goods/goodlist.action" title="商品管理"
	...
	<div data-options="region:'center',title:'主要信息'"
		...
		<!--选项卡  data-options="fit:true" 适应整个窗口属性 -->
